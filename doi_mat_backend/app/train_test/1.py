...
def detect_objects_video(video_path, confidence_threshold=0.5):
    ...
    out = cv2.VideoWriter('../video_test/output.mp4', fourcc, fps, (frame_width, frame_height))
...
if __name__ == "__main__":
    ...
    detection_result = detect_objects_video("../video_test/1.mp4", confidence_threshold=0.5)
